...
$konten = tampilkan("SELECT * FROM tb_detail_keberangkatan ");

if (isset($_POST["cari"])) {
    $konten = cari_keberangkatan($_POST["keyword"]);
}
...
<div class="container-fluid-post px-4">
                <div class="row g-3 my-2">
                    ...
                    <a class="float-start btn btn-primary" href="index.php?p=tambah-keberangkatan"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                    ...
                    <table class="table  table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="fa fa-edit btn btn-warning my-2" href="index.php?p=edit-keberangkatan&id-keberangkatan=<?php echo $penump['id_keberangkatan']; ?>"></a>
                                <a class="hapus fa fa-trash btn btn-danger" name="hapus-keberangkatan" href="index.php?p=fungsi&id-keberangkatan=<?php echo $penump['id_keberangkatan']; ?>" id="btn" onclick="return confirm ('Yakin ingin menghapus data?');" ></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                            <?php endforeach; ?>
